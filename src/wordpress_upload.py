...
def main(args=None):
    ...
    parser.add_argument("--url", help="XML-RPC URL to interface with, e.g., http://example.com/xmlrpc.php")
    parser.add_argument(
        "--dry-run",
        "-n",
        action="store_true",
    ...
    parser.add_argument('--use-post-metadata', action='store_true',
        help='Whether to look for and use JSON metadata information for posts.'
    )
    parser.add_argument('--default-metadata',
